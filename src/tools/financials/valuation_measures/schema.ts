...
export const financialsValuationMeasuresInputSchema = z.object({
...
export type FinancialsValuationMeasuresInput = z.infer<typeof financialsValuationMeasuresInputSchema>;
