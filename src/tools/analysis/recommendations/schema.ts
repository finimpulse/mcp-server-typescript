...
export const analysisRecommendationsInputSchema = z.object({
	...
	limit: z.number().min(1).max(5000).default(10).optional()
		.describe('Maximum number of recommendation snapshots to return.'),
...
export type AnalysisRecommendationsInput = z.infer<typeof analysisRecommendationsInputSchema>;
